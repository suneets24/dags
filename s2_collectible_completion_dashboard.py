...
insert_collectible_player_percent_completion_sql = '''Insert overwrite table as_s2.s2_player_collectible_completion_dashboard 
with collectible_items as
(
select collectionrewardid
		, regexp_replace(regexp_replace(collection_name, 'MPUI_COLLECTION_', ''), 'LOOT_MTX1_COLLECTION_', '') as collection_name
...
insert_collectible_player_percent_completion_task = qubole_operator('insert_collectible_player_percent_completion_task',
                                              insert_collectible_player_percent_completion_sql, 2, timedelta(seconds=600), dag) 
...
insert_collectible_completion_item_task.set_upstream(insert_collectible_completion_task)
insert_collectible_player_percent_completion_task.set_upstream(insert_collectible_completion_item_task)